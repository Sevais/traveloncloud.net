...
<div id="container">
	<div id="body">
		<table>
			<thead>
			<tr>
				<th colspan="5" style="font-size:16px; "><?php echo $_GET['q']; ?></th>
			</tr>
			</thead>
			<tbody>
		<?php
			echo '<tr>';
			foreach ($hotel as $directories => $directory) {
				
			echo '<th style="font-size:12px;"><a href="'.base_url().'index.php/download?f='.$_GET['q'].'/'.$directories.'">'.$directories.'</a></th>';
